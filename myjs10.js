...
if (x >= 140 && x <= 240 && y >= 240 && y <= 310 && car3.x==150 && car3.y==220) {
  if(cnt == 2){cnt=3; car3.moveAngle =-0.38; car3.speed=2;}  else{alert("Ordine errato! Seleziona un'altra macchina!")}
}
});
}

function start(){
  var canvasd = document.getElementById("demo10");
  ...
  //function for drawing cardds and let them move
  ...
  function updateGameArea() {
      ...
      if(card2.x<150){ card3.moveAngle =-0.38; card3.speed=2;}
  }
  //create first card1
